...
- Tools (imported by the flake via flake inputs):
    - gltf_to_png to visualize a picture of a gltf — flake input `gltf-to-png` from https://github.com/M4jor-Tom/gltf_to_png.py
    - gltf_to_webm to visualize a video of a gltf — flake input `gltf-to-webm` from https://github.com/M4jor-Tom/gltf_to_webm.py
